...
//     let string = _.upperFirst(type)
//     let getTemplate = `set${string}`
//     let element = $(`.show_${type}_all_div`)
//     axios.get(`http://debugging.tools/api/get/${type}`).then((array) => {
//         console.log("got the data")
//         let getData = getTemplate(array.data)
//         element.html(getData)
//     })
// }
axios.get(`https://debugging.tools/api/get/problem`).then((array) => {
    console.log("data", array)
    let element = $(`.show_problem_all_div`)
